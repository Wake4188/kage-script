      ...
      <div className="mx-auto flex min-h-dvh w-full max-w-[680px] flex-col px-5 pb-12 pt-6 sm:px-8 sm:pt-10">
        ...
        <article className="mt-14 sm:mt-20">
          ...
          <p className="mt-6 max-w-[60ch] text-base leading-relaxed text-foreground/80 sm:text-lg">
            A short history of the 1676 ninja encyclopedia <em>Bansenshukai</em> (萬川集海) and the
            49-symbol Shinobi Iroha cipher Kage encodes with.
          </p>
        </article>
        ...
        <section className="mt-14 space-y-10">
          <Block n="01" title="What is the Bansenshukai?">
            <p>
              <em>Bansenshukai</em> — literally{" "}
              <span className="font-mono-display">“sea of ten thousand rivers gathered”</span> — is
              a Japanese ninjutsu manual compiled in 1676 by <strong>Fujibayashi Yasutake</strong>,
              a samurai-scholar from Iga descended from one of the three great Iga shinobi families.
              By the early Edo period the wars that defined the ninja's trade had ended, and
              Fujibayashi gathered the surviving oral traditions of Iga and Kōga into a single
              22-volume encyclopedia so the craft would not be lost.
            </p>
            <p>
              The book covers ideology, strategy, infiltration techniques, weapons, tools, weather
              lore, and communications. It was presented to the Tokugawa shogunate but never widely
              circulated; for most of its life it sat in the shogunal library, copied by hand,
          ...
          <Block n="02" title="The Shinobi Iroha — 49 symbols">
            <p>
              Inside the <em>Bansenshukai</em>'s communications chapter is a writing system called
              the
              <strong> Shinobi Iroha</strong> (忍びいろは) — “the ninja iroha.” The classical
              Japanese iroha is a poem that uses every kana exactly once, so it functions as an
              alphabet. The Shinobi Iroha replaces each of the <strong>49 kana</strong> with a
              distinct kanji-like glyph. The result is a simple, rigorous{" "}
              <em>substitution cipher</em>: any Japanese sentence can be transcribed, character by
              character, into a string that looks like obscure literary kanji.
            </p>
            <p>
              The glyphs were not invented from scratch. Many are real but rare characters; others
              are built by combining a left-side radical (water 氵, person 亻, etc.) with a
              right-side component drawn from common kanji like 化, 玄, 立, or 黒. The pattern is
              internally consistent — once you know the grid, you can decode a message without a
              key, but to anyone who has never seen the system it reads as nonsense.
            </p>
          </Block>
          ...
          <Block n="03" title="How a message was encoded">
            ...
            <p>
              The cipher's strength was never mathematical — it is a 1-to-1 substitution, trivial to
              break with a frequency table. Its strength was <strong>contextual</strong>. A captured
              letter looked like a fragment of an obscure Buddhist text or a copying error, not
              military intelligence. Couriers could carry encoded notes hidden inside legitimate
              documents, and a casual reader would simply skim past them.
            </p>
          </Block>

          <Block n="04" title="Why it still matters">
            <p>
              The Shinobi Iroha is one of the earliest documented Japanese ciphers and one of the
              only ninja-era cryptographic systems to survive with a full key intact. It is studied
              today as a piece of cryptographic history, a window into Edo-period communications
              practice, and — for modern audiences — a small but vivid artifact of how the ninja
              actually worked, away from the folklore.
            </p>
            <p>
              <strong>Kage</strong> implements the Shinobi Iroha exactly as it appears in the
              <em> Bansenshukai</em>: 49 kana mapped to 49 glyphs, with dakuten and katakana folded
              down to their base kana before substitution.{" "}
